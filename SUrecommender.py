...
def predictionWithout(id, jogo):
    ...
    print('nan do jogo ', time() - start)
    start = time()
    user_similarity = matrix_norm.T.corr()
    print('user_similarity matrix ', time() - start)
    start = time()
    ...
    print('similar user boards ', time() - start)
    start = time()
    item_score = {}
